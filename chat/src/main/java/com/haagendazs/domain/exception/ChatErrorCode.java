...
public enum ChatErrorCode implements ErrorCode {
    ...
    NOT_MESSAGE_OWNER(HttpStatus.FORBIDDEN, "C005", "본인이 보낸 메시지만 삭제할 수 있습니다."),
    INVALID_SCHEDULED_TIME(HttpStatus.BAD_REQUEST, "C006", "예약 시간이 현재 시간보다 이전입니다."),
    SCHEDULE_MESSAGE_NOT_FOUND(HttpStatus.NOT_FOUND, "C007", "예약 메시지를 찾을 수 없습니다.");
